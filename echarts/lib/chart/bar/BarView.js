...
export default echarts.extendChartView({
    ...
    _renderNormal: function (seriesModel, ecModel, api) {
        ...
        this._data = data;
		 ...
		 var clippath = createClipShape(coord, false, true, seriesModel)
            clippath.style.fill = "#000";
            clippath.style.opacity = 0.5;
...
function createGridClipShape(cartesian, hasAnimation, forSymbol, seriesModel) {
    //var xExtent = getAxisExtentWithGap(cartesian.getAxis('x'));//array
    var xExtent  = cartesian.getAxis('x').getGlobalExtent();
    var yExtent = cartesian.getAxis('y').getGlobalExtent();
    //var yExtent = getAxisExtentWithGap(cartesian.getAxis('y'));//array
    var isHorizontal = cartesian.getBaseAxis().isHorizontal();
    var x = Math.min(xExtent[0], xExtent[1]);
    var y = Math.min(yExtent[0], yExtent[1]);
    var width = Math.max(xExtent[0], xExtent[1]) - x;
    var height = Math.max(yExtent[0], yExtent[1]) - y;
    // console.log("axisextent :"+xExtent);
    // console.log("bbda" +x);
